package com.jagadesh.paymentservice.config;

import com.jagadesh.paymentservice.exception.NonRetryableEventException;
...
public class PaymentConsumerConfig {
    ...
    public ConsumerFactory<String,Object> orderConsumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.jagadesh.event.order,com.jagadesh.event.inventory,com.jagadesh.event.product,com.jagadesh.event.payment");
